...
. "$HOME/lib/bash/utils/context.sh"
. "$HOME/lib/bash/utils/logs.sh"
. "$HOME/lib/bash/utils/format.sh"
. "$HOME/lib/bash/utils/test/safety_checks.sh"

test::format::assert_gen_esc() {
...
test::format::assert_gen_esc "verify reset" "reset" "\e[0m"
test::format::assert_gen_esc "verify escape generation" "bold blue on bright red" "\e[1;34;101m"
